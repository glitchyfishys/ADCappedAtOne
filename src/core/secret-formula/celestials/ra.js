export const ra = {
  pets: {
    teresa: {
      ...
      rawMemoryChunksPerSecond: () => 10 * Math.pow(Currency.eternityPoints.value.pLog10() / 5e3, 3.1),
    ...
    effarig: {
      ...
      rawMemoryChunksPerSecond: () => 10 * Math.pow(Effarig.shardsGained, 0.15),
    ...
    enslaved: {
      ...
      rawMemoryChunksPerSecond: () => 10 * Math.pow(Currency.timeShards.value.pLog10() / 2e5, 2.1),
    ...
    v: {
      ...
      rawMemoryChunksPerSecond: () => 10 * Math.pow(Currency.infinityPower.value.pLog10() / 5e6, 1.7),
