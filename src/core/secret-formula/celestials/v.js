...
export const v = {
  ...
  runUnlocks: [
    ...
    },
    {
      ...
      values: [4000, 4300, 4600, 4800, 5000, 5100],
    ...
    },
    {
      ...
      values: [2.5e5, 3.5e5, 4e5, 4.5e5, 5e5, 5.5e5],
    ...
    },
    {
      ...
      values: [350e6, 400e6, 450e6, 500e6, 600e6, 700e6],
      condition: () => V.isRunning && EternityChallenge(12).isRunning && !PlayerProgress.dilationUnlocked(),
      currentValue: () => player.records.effectiveAntimatter.log10(),
